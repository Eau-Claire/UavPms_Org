...
using UavPms.OperationsService.Application.Features.Monitor.Queries.GetDefectStatistics;
using UavPms.OperationsService.Application.Features.Monitor.Queries.GetInspectionHistory;
