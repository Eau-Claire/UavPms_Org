...
public interface ITowerRepository : IGenericRepository<Tower> 
{
    ...
    Task<IReadOnlyList<Tower>> GetByIdsAsync(IReadOnlyCollection<Guid> ids, CancellationToken cancellationToken);
    Task<IReadOnlyDictionary<Guid, Guid>> GetRegionIdsByTowerIdsAsync(IReadOnlyCollection<Guid> ids, CancellationToken cancellationToken);
