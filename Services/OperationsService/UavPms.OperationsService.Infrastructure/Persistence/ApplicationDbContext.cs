...
public class ApplicationDbContext : DbContext
{
    ...
    public DbSet<UserRegionAssignment> UserRegionAssignments => Set<UserRegionAssignment>();
    ...
    public DbSet<TowerHealthHistory> TowerHealthHistories => Set<TowerHealthHistory>();
    ...
    private static void ApplySoftDeleteFilter(ModelBuilder modelBuilder, Type entityType)
    {
        try
        {
            ...
            // Use dynamic to invoke the generic method
            dynamic builder = modelBuilder.Entity(entityType);
            builder.HasQueryFilter(lambda);
        }
        catch (Exception ex)
        {
            // Log warning but don't fail - soft delete filtering is important but not critical to function
