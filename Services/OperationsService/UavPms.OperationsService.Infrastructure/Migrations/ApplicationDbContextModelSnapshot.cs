...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("UavPms.OperationsService.Domain.Entities.AssetComponent", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("UavPms.OperationsService.Domain.Entities.TowerHealthHistory", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.ToTable("TowerHealthHistories", (string)null);
                });
            ...
            modelBuilder.Entity("UavPms.OperationsService.Domain.Entities.UserRegionAssignment", b =>
                {
                    b.Property<Guid>("UserId").HasColumnType("uuid");
                    b.Property<Guid>("RegionId").HasColumnType("uuid");
                    b.Property<DateTimeOffset>("AssignedAt").HasColumnType("timestamp with time zone");
                    b.Property<Guid>("AssignedBy").HasColumnType("uuid");
                    b.HasKey("UserId", "RegionId");
                    b.HasIndex("RegionId");
                    b.HasIndex("UserId", "RegionId").IsUnique();
                    b.ToTable("UserRegionAssignments", (string)null);
                });
            ...
            modelBuilder.Entity("UavPms.OperationsService.Domain.Entities.TowerHealthHistory", b =>
                {
                    b.HasOne("UavPms.OperationsService.Domain.Entities.AssetComponent", "Tower")
            ...
            modelBuilder.Entity("UavPms.OperationsService.Domain.Entities.DetectedAnomaly", b =>
                {
                    ...
                    b.HasOne("UavPms.OperationsService.Domain.Entities.AssetComponent", "Component")
