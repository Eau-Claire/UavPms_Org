...
public static class DependencyInjection
{
    ...
    public static IServiceCollection AddInfrastructureServices(this IServiceCollection services, IConfiguration configuration)
    {
        ...
        services.AddScoped<IOtpPurposeHandler, UavPms.NotificationService.Infrastructure.Services.OtpHandlers.LoginOtpHandler>();
        services.AddScoped<IOtpPurposeHandler, UavPms.NotificationService.Infrastructure.Services.OtpHandlers.ForgotPasswordOtpHandler>();
        services.AddScoped<IOtpPurposeHandler, UavPms.NotificationService.Infrastructure.Services.OtpHandlers.EmailVerificationOtpHandler>();
        services.AddScoped<IOtpPurposeHandler, UavPms.NotificationService.Infrastructure.Services.OtpHandlers.ChangeEmailOtpHandler>();
        services.AddScoped<IOtpPurposeHandler, UavPms.NotificationService.Infrastructure.Services.OtpHandlers.ChangePasswordOtpHandler>();
        services.AddScoped<IOtpPurposeHandler, UavPms.NotificationService.Infrastructure.Services.OtpHandlers.DeleteAccountOtpHandler>();
