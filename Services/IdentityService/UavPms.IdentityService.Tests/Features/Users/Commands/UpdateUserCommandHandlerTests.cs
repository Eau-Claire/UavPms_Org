...
namespace UavPms.IdentityService.Tests.Features.Users.Commands.UpdateUser;
...
public class UpdateUserCommandHandlerTests
{
    ...
    public async Task Handle_ShouldUpdateUser_WhenDataIsValid()
    {
        ...
        var command = new UpdateUserCommand(userId, " ExistingEmail@GMAIL.COM ", "Name", "123", "Active", new List<string>{ "Manager" });
        
        _userRepositoryMock.Setup(r => r.GetByIdWithRolesAsync(userId)).ReturnsAsync(existingUser);
        _userRepositoryMock.Setup(r => r.GetByEmailWithRolesAsync("existingemail@gmail.com")).ReturnsAsync((User?)null);
        ...
        existingUser.Email.Should().Be("existingemail@gmail.com");
